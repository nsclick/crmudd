...
<body data-ng-controller="ExecutivesPanelController">
	...
	<?php //$helper->debug ( $app_strings ); ?>
	
	<!-- Navbar -->
	<div class="salespanel_navbar navbar navbar-inverse" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          <a class="navbar-brand" href="<?php echo $_SERVER['PHP_SELF']; ?>">UDD CRM</a>
        </div>
        <div class="">
			...
			<div class="col-md-12">
				...
				<form role="form">
					...
					<div class="form-group">
						...
						<select class="form-control" data-ng-model="course" id="course" data-ng-options="course.label for course in courses" required></select>
					</div>
		...
		(function(window, angular, undefined) {
			angular.module('Globals', [])
				...
				.constant('urls', {
					...
					base:	<?php echo '\'http:\/\/' . $_SERVER['SERVER_NAME'] . '\/ref\/index.php\''; ?>,
					workflow: 	<?php echo '\'http:\/\/' . $_SERVER['SERVER_NAME'] . '\/ref\/index.php?entryPoint=webForm2\''; ?>
				})
