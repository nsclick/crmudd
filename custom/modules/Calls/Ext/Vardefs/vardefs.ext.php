...
$dictionary['Call']['fields']['name']['name'] = 'name';
$dictionary['Call']['fields']['name']['type'] = 'enum';
$dictionary['Call']['fields']['name']['options'] = 'calls_names_list_c';

 


 // created: 2014-04-15 16:26:27
$dictionary['Call']['fields']['tipo_de_llamada_c']['labelValue']='Tipo de llamada';

 

 // created: 2014-04-15 16:20:58
